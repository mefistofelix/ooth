...
- README describes configuration, protocol, patch requirements and limitations. CI builds/tests both OSes on push; workflow_dispatch publishes prerelease binaries and SHA256SUMS. GUI notification handling and real Linux PID 1 execution still need dedicated validation before production use.
