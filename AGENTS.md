...
- README describes configuration, protocol, patch requirements and limitations. CI builds/tests both OSes on push; workflow_dispatch publishes prerelease binaries and SHA256SUMS. Repository: https://github.com/mefistofelix/ooth (private).
